...
export default function SignIn({ onLogin }: SigninProps) {
  ...
  return (
    <div 
      className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden w-full"
      style={{
            ...
            <div className="space-y-5">
              <div className="text-center mb-6">
                ...
                <p className={`text-sm font-medium ${isDarkTheme ? 'text-gray-400' : 'text-gray-600'}`}>
                  Login in to check the details of various things
                </p>
              </div>
              ...
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-gradient-to-r from-blue-600 to-green-500 text-white rounded-xl font-bold hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300"
                >
                  Sign in
                </button>
              </form>
